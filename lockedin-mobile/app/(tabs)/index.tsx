...
export default function DashboardScreen() {
  ...
  const completedChallenges = mockDashboardData.challenges.filter(
  ...
  const openChallenge = (challenge: DashboardChallenge) => {
    showPlaceholder(
      challenge.name,
      'The challenge dashboard route will be connected here in the next frontend pass.',
    );
  };
    ...
    <SafeAreaView edges={['top', 'left', 'right']} style={[styles.safeArea, { backgroundColor: colors.surface }]}>
      <View style={[styles.header, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
        <View style={styles.headerInner}>
          ...
          <Pressable
            ...
            hitSlop={8}
            onPress={() => showPlaceholder('Settings', 'Account settings will open here.')}
            style={({ pressed }) => [
              styles.avatar,
      ...
      <ScrollView
        ...
        <View style={styles.contentInner}>
          ...
          <DashboardSection title="Your challenges" count={activeChallenges.length} colors={colors}>
            ...
            <Pressable
              ...
              onPress={() =>
                showPlaceholder(
                  'Add a Challenge',
                  'The activity form and challenge picker will be connected here.',
                )
              }
              style={({ pressed }) => [
                styles.addAction,
          ...
          <DashboardSection title="Finished challenges" count={completedChallenges.length} colors={colors}>
